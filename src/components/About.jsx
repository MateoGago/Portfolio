...
function About() {
  ...
  return (
    <section id="about" className="py-16 px-8 max-w-3xl mx-auto text-center">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-slate-50 mb-6">
        {language === "es" ? "Sobre mí" : "About me"}
      </h2>
      <div className="bg-white dark:bg-[#111b2d] rounded-xl p-8 shadow-sm dark:shadow-xl dark:shadow-black/20 border border-gray-100 dark:border-white/10 text-left transition-colors">
        <p className="text-gray-600 dark:text-[#b8c4d6] text-lg leading-relaxed mb-4">
          {language === "es"
        ...
        <p className="text-gray-600 dark:text-[#b8c4d6] text-lg leading-relaxed">
          {language === "es"
